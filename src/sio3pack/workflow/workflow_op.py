class WorkflowOperation:
    def __init__(self, get_workflow_func: callable, return_results = False, return_results_func: callable = None, *wf_args, **wf_kwargs):
    ...
    def get_workflow(self):
        while not self._last:
            self._workflow, self._last = self.get_workflow_func(self._data, *self._workflow_args, **self._workflow_kwargs)
